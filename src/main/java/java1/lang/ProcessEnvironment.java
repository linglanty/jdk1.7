...
{
    private static final java.util.HashMap<Variable,Value> theEnvironment;
    private static final java.util.Map<String,String> theUnmodifiableEnvironment;
    ...
    static {
        ...
        theEnvironment = new java.util.HashMap<>(environ.length/2 + 3);
    ...
    static java.util.Map<String,String> getenv() {
    ...
    static java.util.Map<String,String> environment() {
        return new StringEnvironment
            ((java.util.Map<Variable,Value>)(theEnvironment.clone()));
    }

    /* Only for use by Runtime.exec(...String[]envp...) */
    static java.util.Map<String,String> emptyEnvironment(int capacity) {
        return new StringEnvironment(new java.util.HashMap<Variable,Value>(capacity));
    }
    ...
    private static class StringEnvironment
        extends java.util.AbstractMap<String,String>
    {
        private java.util.Map<Variable,Value> m;
        private static String toString(Value v) {
            return v == null ? null : v.toString();
        }
        public StringEnvironment(java.util.Map<Variable,Value> m) {this.m = m;}
        ...
        public byte[] toEnvironmentBlock(int[]envc) {
            ...
            for (java.util.Map.Entry<Variable,Value> entry : m.entrySet()) {
    ...
    static byte[] toEnvironmentBlock(java.util.Map<String,String> map, int[]envc) {
    ...
    {
        private final java.util.Map.Entry<Variable,Value> e;
        public StringEntry(java.util.Map.Entry<Variable,Value> e) {this.e = e;}
    ...
    private static class StringEntrySet
        extends java.util.AbstractSet<java.util.Map.Entry<String,String>>
    {
        private final java.util.Set<java.util.Map.Entry<Variable,Value>> s;
        public StringEntrySet(java.util.Set<java.util.Map.Entry<Variable,Value>> s) {this.s = s;}
        public int size()        {return s.size();}
        public boolean isEmpty() {return s.isEmpty();}
        public void clear()      {       s.clear();}
        public java.util.Iterator<java.util.Map.Entry<String,String>> iterator() {
            return new java.util.Iterator<java.util.Map.Entry<String,String>>() {
                java.util.Iterator<java.util.Map.Entry<Variable,Value>> i = s.iterator();
        ...
        private static java.util.Map.Entry<Variable,Value> vvEntry(final Object o) {
            if (o instanceof StringEntry)
                return ((StringEntry)o).e;
            return new java.util.Map.Entry<Variable,Value>() {
                public Variable getKey() {
                    return Variable.valueOfQueryOnly(((java.util.Map.Entry)o).getKey());
                }
                public Value getValue() {
                    return Value.valueOfQueryOnly(((java.util.Map.Entry)o).getValue());
                }
    ...
    {
        private final java.util.Collection<Value> c;
        public StringValues(java.util.Collection<Value> c) {this.c = c;}
        public int size()        {return c.size();}
        public boolean isEmpty() {return c.isEmpty();}
        public void clear()      {       c.clear();}
        public java.util.Iterator<String> iterator() {
            return new java.util.Iterator<String>() {
                java.util.Iterator<Value> i = c.iterator();
                public boolean hasNext() {return i.hasNext();}
    ...
    private static class StringKeySet extends java.util.AbstractSet<String> {
        private final java.util.Set<Variable> s;
        public StringKeySet(java.util.Set<Variable> s) {this.s = s;}
        public int size()        {return s.size();}
        public boolean isEmpty() {return s.isEmpty();}
        public void clear()      {       s.clear();}
        public java.util.Iterator<String> iterator() {
            return new java.util.Iterator<String>() {
                java.util.Iterator<Variable> i = s.iterator();
                public boolean hasNext() {return i.hasNext();}
                public String next()     {return i.next().toString();}
                public void remove()     {       i.remove();}
            };
