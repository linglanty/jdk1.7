...
public class Hashtable<K,V>
    ...
    private <T> java.util.Enumeration<T> getEnumeration(int type) {
        if (count == 0) {
     ...
     */
    private transient volatile java.util.Set<K> keySet = null;
    private transient volatile java.util.Set<Map.Entry<K,V>> entrySet = null;
    private transient volatile java.util.Collection<V> values = null;
    ...
    public java.util.Set<K> keySet() {
        if (keySet == null)
            keySet = java.util.Collections.synchronizedSet(new KeySet(), this);
        return keySet;
    }
    ...
    public java.util.Set<Map.Entry<K,V>> entrySet() {
        if (entrySet==null)
            entrySet = java.util.Collections.synchronizedSet(new EntrySet(), this);
        return entrySet;
    }
    ...
    public java.util.Collection<V> values() {
        if (values==null)
            values = java.util.Collections.synchronizedCollection(new ValueCollection(),
                                                        this);
        return values;
    }

    private class ValueCollection extends java.util.AbstractCollection<V> {
    ...
    public synchronized boolean equals(Object o) {
        ...
        try {
            java.util.Iterator<Map.Entry<K,V>> i = entrySet().iterator();
            while (i.hasNext()) {
     ...
     */
    private class Enumerator<T> implements java.util.Enumeration<T>, java.util.Iterator<T> {
