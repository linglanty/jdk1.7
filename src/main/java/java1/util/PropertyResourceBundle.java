 ...
 * {@link java.util.ResourceBundle ResourceBundle} for more information about resource
 * bundles.
 *
 * <p>
 ...
 * {@link java.util.ResourceBundle#getBundle(java.lang.String, Locale, java.lang.ClassLoader) ResourceBundle.getBundle}
...
public class PropertyResourceBundle extends java.util.ResourceBundle {
    ...
    public PropertyResourceBundle (InputStream stream) throws IOException {
        ...
        lookup = new java.util.HashMap(properties);
    }
    ...
    public java.util.Enumeration<String> getKeys() {
        java.util.ResourceBundle parent = this.parent;
