...
public class PriorityQueue<E> extends AbstractQueue<E>
     ...
     * a {@link java.util.SortedSet} or is another {@code PriorityQueue}, this
    ...
    public PriorityQueue(PriorityQueue<? extends E> c) {
        this.comparator = (java.util.Comparator<? super E>) c.comparator();
        ...
        public void remove() {
            ...
            if (lastRet != -1) {
                ...
                if (moved == null)
                    ...
                    if (forgetMeNot == null)
                        forgetMeNot = new java.util.ArrayDeque<>();
