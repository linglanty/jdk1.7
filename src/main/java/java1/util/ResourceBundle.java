 ...
 * {@link #getBundle(java.lang.String, Locale) getBundle}
 * method:
 * <blockquote>
 * <pre>
...
public abstract class ResourceBundle {
    ...
    private static final ResourceBundle NONEXISTENT_BUNDLE = new ResourceBundle() {
            public java.util.Enumeration<String> getKeys() { return null; }
     ...
     */
    private volatile java.util.Set<String> keySet;
    ...
    public final Object getObject(String key) {
        ...
        if (obj == null) {
            ...
            if (obj == null)
                throw new java.util.MissingResourceException("Can't find resource for bundle "
     ...
     * java.util.PropertyResourceBundle} instance from its contents.  If successful, this
     ...
     * designate class-based and {@linkplain java.util.PropertyResourceBundle
    ...
    private static ResourceBundle getBundleImpl(String baseName, Locale locale,
        ...
        java.util.List<String> formats = control.getFormats(baseName);
        ...
        for (Locale targetLocale = locale;
            ...
            java.util.List<Locale> candidateLocales = control.getCandidateLocales(baseName, targetLocale);
    ...
    private static final ResourceBundle findBundle(CacheKey cacheKey,
                                                   java.util.List<Locale> candidateLocales,
    ...
    private static final void throwMissingResourceException(String baseName,
        ...
        throw new java.util.MissingResourceException("Can't find bundle for base name "
    ...
    public static final void clearCache(ClassLoader loader) {
        ...
        java.util.Set<CacheKey> set = cacheList.keySet();
    ...
    protected java.util.Set<String> handleKeySet() {
        if (keySet == null) {
            synchronized (this) {
                if (keySet == null) {
                    java.util.Set<String> keys = new java.util.HashSet<>();
                    java.util.Enumeration<String> enumKeys = getKeys();
     ...
     * name separators.
     *
     * <p>Two factory methods, {@link #getControl(java.util.List)} and {@link
     * #getNoFallbackControl(java.util.List)}, provide
     ...
     * using {@link java.util.Properties#loadFromXML(java.io.InputStream)
    ...
    public static class Control {
         ...
         * java.util.Collections#unmodifiableList(java.util.List) unmodifiable}.
         *
         * @see #getFormats(String)
         */
        public static final java.util.List<String> FORMAT_DEFAULT
            = java.util.Collections.unmodifiableList(java.util.Arrays.asList("java.class",
                                                         "java.properties"));
        ...
        public static final java.util.List<String> FORMAT_PROPERTIES
            = java.util.Collections.unmodifiableList(java.util.Arrays.asList("java.properties"));
         ...
         */
        public static final Control getControl(java.util.List<String> formats) {
         ...
         *        if <code>formats</code> is unknown
         */
        public static final Control getNoFallbackControl(java.util.List<String> formats) {
            if (formats.equals(Control.FORMAT_DEFAULT)) {
         ...
         * </ol>
         *
         * <p>The default implementation uses an {@link java.util.ArrayList} that
        ...
        public java.util.List<Locale> getCandidateLocales(String baseName, Locale locale) {
            ...
            return new java.util.ArrayList<>(CANDIDATES_CACHE.get(locale.getBaseLocale()));
        }

        private static final CandidateListCache CANDIDATES_CACHE = new CandidateListCache();

        private static class CandidateListCache extends LocaleObjectCache<BaseLocale, java.util.List<Locale>> {
            protected java.util.List<Locale> createObject(BaseLocale base) {
                ...
                if (language.equals("nb") || isNorwegianBokmal) {
                    java.util.List<Locale> tmpList = getDefaultList("nb", script, region, variant);
                    // Insert a locale replacing "nb" with "no" for every list entry
                    java.util.List<Locale> bokmalList = new java.util.LinkedList<>();
                    ...
                    java.util.List<Locale> nynorskList = getDefaultList("nn", script, region, variant);
            ...
            private static java.util.List<Locale> getDefaultList(String language, String script, String region, String variant) {
                java.util.List<String> variants = null;
                ...
                java.util.List<Locale> list = new java.util.LinkedList<>();
        ...
        public ResourceBundle newBundle(String baseName, Locale locale, String format,
            ...
            if (format.equals("java.class")) {
                ...
                if (stream != null) {
                    try {
                        bundle = new java.util.PropertyResourceBundle(stream);
                    } finally {
                        stream.close();
                    }
                }
    ...
    private static class SingleFormatControl extends Control {
        private static final Control PROPERTIES_ONLY
            = new SingleFormatControl(java.util.ResourceBundle.Control.FORMAT_PROPERTIES);

        private static final Control CLASS_ONLY
            = new SingleFormatControl(java.util.ResourceBundle.Control.FORMAT_CLASS);

        private final java.util.List<String> formats;

        protected SingleFormatControl(java.util.List<String> formats) {
    ...
    private static final class NoFallbackControl extends SingleFormatControl {
        private static final Control NO_FALLBACK
            = new NoFallbackControl(java.util.ResourceBundle.Control.FORMAT_DEFAULT);

        private static final Control PROPERTIES_ONLY_NO_FALLBACK
            = new NoFallbackControl(java.util.ResourceBundle.Control.FORMAT_PROPERTIES);

        private static final Control CLASS_ONLY_NO_FALLBACK
            = new NoFallbackControl(java.util.ResourceBundle.Control.FORMAT_CLASS);

        protected NoFallbackControl(java.util.List<String> formats) {
            super(formats);
        }
