 ...
 * java.util.ServiceConfigurationError} to be thrown when this class attempts to parse
    ...
    implements Iterable<S>
{
    ...
    {
        throw new java.util.ServiceConfigurationError(service.getName() + ": " + msg,
                                            cause);
    }
    ...
    private int parseLine(Class service, URL u, BufferedReader r, int lc,
        ...
        throws IOException, java.util.ServiceConfigurationError
    {
    ...
    //
    private java.util.Iterator<String> parse(Class service, URL u)
        throws java.util.ServiceConfigurationError
    {
        InputStream in = null;
        ...
        implements java.util.Iterator<S>
    {
        ...
        Class<S> service;
        ClassLoader loader;
        java.util.Enumeration<URL> configs = null;
        java.util.Iterator<String> pending = null;
     ...
     * {@link java.util.ServiceConfigurationError} if a provider-configuration file
     * violates the specified format, or if it names a provider class that
     * cannot be found and instantiated, or if the result of instantiating the
     * class is not assignable to the service type, or if any other kind of
     * exception or error is thrown as the next provider is located and
     * instantiated.  To write robust code it is only necessary to catch {@link
     * java.util.ServiceConfigurationError} when using a service iterator.
     *
    ...
    public java.util.Iterator<S> iterator() {
        return new java.util.Iterator<S>() {
            ...
            java.util.Iterator<java.util.Map.Entry<String,S>> knownProviders
