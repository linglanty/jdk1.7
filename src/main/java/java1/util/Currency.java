...
public final class Currency implements Serializable {
    ...
    private static java.util.HashSet<Currency> available;
    ...
    public static java.util.Set<Currency> getAvailableCurrencies() {
        synchronized(Currency.class) {
            if (available == null) {
                available = new java.util.HashSet<Currency>(256);
                ...
                java.util.StringTokenizer st = new java.util.StringTokenizer(otherCurrencies, "-");
        ...
        @SuppressWarnings("unchecked") java.util.Set<Currency> result = (java.util.Set<Currency>) available.clone();
        return result;
    }
    ...
    public String getSymbol() {
        return getSymbol(java.util.Locale.getDefault(java.util.Locale.Category.DISPLAY));
    }
    ...
    public String getSymbol(java.util.Locale locale) {
        try {
            ...
            java.util.ResourceBundle bundle = LocaleData.getCurrencyNames(locale);
    ...
    public String getDisplayName(java.util.Locale locale) {
        try {
            ...
            String result = null;
            String bundleKey = currencyCode.toLowerCase(java.util.Locale.ROOT);
