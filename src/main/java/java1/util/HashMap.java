    ...
    implements Map<K,V>, Cloneable, Serializable
{
    ...
    private abstract class HashIterator<E> implements java.util.Iterator<E> {
    ...
    java.util.Iterator<Map.Entry<K,V>> newEntryIterator()   {
    ...
    private final class EntrySet extends java.util.AbstractSet<Map.Entry<K,V>> {
