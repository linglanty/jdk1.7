...
public abstract class Calendar implements Serializable, Cloneable, Comparable<Calendar> {
     ...
     * of a Locale.
     */
    private static final ConcurrentMap<java.util.Locale, int[]> cachedLocaleData
        = new ConcurrentHashMap<java.util.Locale, int[]>(3);
    ...
    protected Calendar()
    {
        this(java.util.TimeZone.getDefaultRef(), java.util.Locale.getDefault(java.util.Locale.Category.FORMAT));
        sharedZone = true;
    }
    ...
    {
        Calendar cal = createCalendar(java.util.TimeZone.getDefaultRef(), java.util.Locale.getDefault(java.util.Locale.Category.FORMAT));
        cal.sharedZone = true;
        return cal;
    }
    ...
    {
        return createCalendar(zone, java.util.Locale.getDefault(java.util.Locale.Category.FORMAT));
    }
    ...
    {
        Calendar cal = createCalendar(java.util.TimeZone.getDefaultRef(), aLocale);
        cal.sharedZone = true;
        return cal;
    }
    ...
    private static Calendar createCalendar(java.util.TimeZone zone,
                                           java.util.Locale aLocale)
    {
        Calendar cal = null;
        ...
        if (caltype == null) {
            ...
            if ("th".equals(aLocale.getLanguage())
                ...
                cal = new java.util.GregorianCalendar(zone, aLocale);
            }
     ...
     * @since 1.6
     */
    public String getDisplayName(int field, int style, java.util.Locale locale) {
     ...
     * java.util.GregorianCalendar}, the returned map would contain "Jan" to
     ...
     * @since 1.6
     */
    public java.util.Map<String, Integer> getDisplayNames(int field, int style, java.util.Locale locale) {
        if (!checkDisplayNameParams(field, style, ALL_STYLES, LONG, locale,
                                    ERA_MASK|MONTH_MASK|DAY_OF_WEEK_MASK|AM_PM_MASK)) {
            return null;
        }
        ...
        // ALL_STYLES
        if (style == ALL_STYLES) {
            java.util.Map<String,Integer> shortNames = getDisplayNamesImpl(field, SHORT, locale);
            if (field == ERA || field == AM_PM) {
                return shortNames;
            }
            java.util.Map<String,Integer> longNames = getDisplayNamesImpl(field, LONG, locale);
            if (shortNames == null) {
                return longNames;
            }
            if (longNames != null) {
    ...
    private java.util.Map<String,Integer> getDisplayNamesImpl(int field, int style, java.util.Locale locale) {
        DateFormatSymbols symbols = DateFormatSymbols.getInstance(locale);
        String[] strings = getFieldStrings(field, style, symbols);
        if (strings != null) {
            java.util.Map<String,Integer> names = new java.util.HashMap<String,Integer>();
    ...
    boolean checkDisplayNameParams(int field, int style, int minStyle, int maxStyle,
                                   java.util.Locale locale, int fieldMask) {
    ...
    public java.util.TimeZone getTimeZone()
    {
        ...
        // create a clone.
        if (sharedZone) {
            zone = (java.util.TimeZone) zone.clone();
            sharedZone = false;
        }
        return zone;
    }
    ...
    private void setWeekCountData(java.util.Locale desiredLocale)
    {
        ...
        if (data == null) {  /* cache miss */
            java.util.ResourceBundle bundle = LocaleData.getCalendarData(desiredLocale);
            data = new int[2];
         ...
         throws IOException
    {
        ...
        java.util.TimeZone savedZone = null;
        if (zone instanceof ZoneInfo) {
            java.util.SimpleTimeZone stz = ((ZoneInfo)zone).getLastRuleInstance();
            if (stz == null) {
                stz = new java.util.SimpleTimeZone(zone.getRawOffset(), zone.getID());
            }
            savedZone = zone;
            zone = stz;
        }
         ...
         throws IOException, ClassNotFoundException
    {
        ...
        if (zone instanceof java.util.SimpleTimeZone) {
