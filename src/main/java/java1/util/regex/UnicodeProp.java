...
enum UnicodeProp {
    ...
    HEX_DIGIT {
        ...
        public boolean is(int ch) {
            return java.util.regex.UnicodeProp.DIGIT.is(ch) ||
                   (ch >= 0x0030 && ch <= 0x0039) ||
                   (ch >= 0x0041 && ch <= 0x0046) ||
                   (ch >= 0x0061 && ch <= 0x0066) ||
                   (ch >= 0xFF10 && ch <= 0xFF19) ||
    ...
    ALNUM {
        ...
        // \p{digit}
        public boolean is(int ch) {
            return java.util.regex.UnicodeProp.ALPHABETIC.is(ch) || java.util.regex.UnicodeProp.DIGIT.is(ch);
        }
    },
    ...
    PRINT {
        ...
        // -- \p{cntrl}
        public boolean is(int ch) {
            return (java.util.regex.UnicodeProp.GRAPH.is(ch) || java.util.regex.UnicodeProp.BLANK.is(ch)) && !java.util.regex.UnicodeProp.CONTROL.is(ch);
        }
    },
    ...
    WORD {
        ...
        public boolean is(int ch) {
            return java.util.regex.UnicodeProp.ALPHABETIC.is(ch) ||
