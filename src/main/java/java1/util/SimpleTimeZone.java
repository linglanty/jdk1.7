 ...
 * value, such as {@link java.util.Calendar#MARCH}. The <em>day-of-week</em> value is
 ...
 * example, to specify March 1, set the <em>month</em> to {@link java.util.Calendar#MARCH
 ...
 * java.util.Calendar#DAY_OF_WEEK DAY_OF_WEEK} field value. For example, to specify the
 ...
 * java.util.Calendar#SUNDAY SUNDAY}.</li>
 *
 ...
 * to {@link java.util.Calendar#OCTOBER OCTOBER}, <em>day-of-week</em> to {@link
 * java.util.Calendar#SUNDAY SUNDAY} and <em>day-of-month</em> to -1.  </li>
 *
 * </ul>
...
public class SimpleTimeZone extends java.util.TimeZone {
    ...
    /**
     * @see java.util.TimeZone#getOffsets
     */
    int getOffsets(long date, int[] offsets) {
      ...
      computeOffset:
        if (useDaylight) {
            ...
            BaseCalendar cal = date >= java.util.GregorianCalendar.DEFAULT_GREGORIAN_CUTOVER ?
                gcal : (BaseCalendar) CalendarSystem.forName("julian");
            BaseCalendar.Date cdate = (BaseCalendar.Date) cal.newCalendarDate(java.util.TimeZone.NO_TIMEZONE);
   ...
   /**
     ...
     * uses a default {@link java.util.GregorianCalendar} object as its
                         ...
                         int millis)
    {
        ...
        if (time < java.util.GregorianCalendar.DEFAULT_GREGORIAN_CUTOVER) {
            cal = (BaseCalendar) CalendarSystem.forName("julian");
            cdate = (BaseCalendar.Date) cal.newCalendarDate(java.util.TimeZone.NO_TIMEZONE);
        ...
        if ((cdate.getNormalizedYear() != y)
            ...
            // compatibility.
            || (dayOfWeek < java.util.Calendar.SUNDAY || dayOfWeek > java.util.Calendar.SATURDAY)
            || (millis < 0 || millis >= (24*60*60*1000))) {
            throw new IllegalArgumentException();
        }

        if (!useDaylight || year < startYear || era != java.util.GregorianCalendar.CE) {
            return rawOffset;
        }
    ...
    /**
     * The year in which daylight saving time is first observed.  This is an {@link java.util.GregorianCalendar#AD AD}
    ...
    private void decodeStartRule() {
        ...
        if (startDay != 0) {
            if (startMonth < java.util.Calendar.JANUARY || startMonth > java.util.Calendar.DECEMBER) {
                throw new IllegalArgumentException(
            ...
            if (startDayOfWeek == 0) {
                ...
                if (startDayOfWeek > java.util.Calendar.SATURDAY) {
                    throw new IllegalArgumentException(
    ...
    private void decodeEndRule() {
        useDaylight = (startDay != 0) && (endDay != 0);
        if (endDay != 0) {
            if (endMonth < java.util.Calendar.JANUARY || endMonth > java.util.Calendar.DECEMBER) {
                throw new IllegalArgumentException(
            ...
            if (endDayOfWeek == 0) {
                ...
                if (endDayOfWeek > java.util.Calendar.SATURDAY) {
                    throw new IllegalArgumentException(
    ...
    private void makeRulesCompatible()
    {
        ...
        case DOM_MODE:
            endDay = 1 + (endDay / 7);
            endDayOfWeek = java.util.Calendar.SUNDAY;
            break;
