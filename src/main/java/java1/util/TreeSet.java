...
/**
 * A {@link java.util.NavigableSet} implementation based on a {@link java.util.TreeMap}.
...
public class TreeSet<E> extends java.util.AbstractSet<E>
    implements java.util.NavigableSet<E>, Cloneable, java.io.Serializable
{
    /**
     * The backing map.
     */
     ...
     */
    TreeSet(java.util.NavigableMap<E,Object> m) {
        this.m = m;
    }
    ...
    public  boolean addAll(java.util.Collection<? extends E> c) {
        ...
        if (m.size()==0 && c.size() > 0 &&
            c instanceof java.util.SortedSet &&
            m instanceof java.util.TreeMap) {
            java.util.SortedSet<? extends E> set = (java.util.SortedSet<? extends E>) c;
            java.util.TreeMap<E,Object> map = (java.util.TreeMap<E, Object>) m;
            java.util.Comparator<? super E> cc = (java.util.Comparator<? super E>) set.comparator();
            java.util.Comparator<? super E> mc = map.comparator();
    ...
    private void readObject(java.io.ObjectInputStream s)
        ...
        // Read in Comparator
        java.util.Comparator<? super E> c = (java.util.Comparator<? super E>) s.readObject();

        // Create backing TreeMap
        java.util.TreeMap<E,Object> tm;
        if (c==null)
            tm = new java.util.TreeMap<>();
        else
            tm = new java.util.TreeMap<>(c);
        m = tm;
