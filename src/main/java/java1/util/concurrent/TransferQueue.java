 ...
 * {@linkplain #tryTransfer(Object,long, java.util.concurrent.TimeUnit) time-out} versions of
...
public interface TransferQueue<E> extends java.util.concurrent.BlockingQueue<E> {
     ...
     * timed {@link #poll(long, java.util.concurrent.TimeUnit) poll}.
     ...
     * {@link #poll(long, java.util.concurrent.TimeUnit) poll}.  The return value is an
