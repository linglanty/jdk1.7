 ...
 * java.util.Iterator} interfaces.  The Iterator provided in method {@link
...
public class PriorityBlockingQueue<E> extends java.util.AbstractQueue<E>
     ...
     * {@link java.util.SortedSet} or a {@link java.util.PriorityQueue},  this
    ...
    public PriorityBlockingQueue(java.util.Collection<? extends E> c) {
        ...
        if (c instanceof java.util.SortedSet<?>) {
            java.util.SortedSet<? extends E> ss = (java.util.SortedSet<? extends E>) c;
            this.comparator = (java.util.Comparator<? super E>) ss.comparator();
            heapify = false;
        }
        else if (c instanceof PriorityBlockingQueue<?>) {
            PriorityBlockingQueue<? extends E> pq =
                (PriorityBlockingQueue<? extends E>) c;
            this.comparator = (java.util.Comparator<? super E>) pq.comparator();
            screen = false;
        ...
        if (a.getClass() != Object[].class)
            a = java.util.Arrays.copyOf(a, n, Object[].class);
    ...
    private E dequeue() {
        ...
        if (n < 0)
            ...
            E x = (E) array[n];
            array[n] = null;
            java.util.Comparator<? super E> cmp = comparator;
            if (cmp == null)
     ...
     *  {@link BlockingQueue#offer(Object,long, java.util.concurrent.TimeUnit) BlockingQueue.offer})
     * @throws ClassCastException if the specified element cannot be compared
     *         with elements currently in the priority queue according to the
     *         priority queue's ordering
     * @throws NullPointerException if the specified element is null
    ...
    public E poll(long timeout, java.util.concurrent.TimeUnit unit) throws InterruptedException {
    ...
    private void writeObject(java.io.ObjectOutputStream s)
        ...
        try {
            ...
            q = new java.util.PriorityQueue<E>(Math.max(size, 1), comparator);
            q.addAll(this);
