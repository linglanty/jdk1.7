...
public class Exchanger<V> {
     ...
     */
    private static final class Node extends java.util.concurrent.atomic.AtomicReference<Object> {
     ...
     * extra space.
     */
    private static final class Slot extends java.util.concurrent.atomic.AtomicReference<Object> {
     ...
     */
    private final java.util.concurrent.atomic.AtomicInteger max = new java.util.concurrent.atomic.AtomicInteger();
     ...
     * java.util.concurrent.TimeoutException} is thrown.  If the time is less than or equal
     ...
     */
    public V exchange(V x, long timeout, java.util.concurrent.TimeUnit unit)
