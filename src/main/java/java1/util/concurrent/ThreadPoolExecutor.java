 ...
 * of {@code Long.MAX_VALUE} {@link java.util.concurrent.TimeUnit#NANOSECONDS} effectively
 ...
 * java.util.concurrent.RejectedExecutionHandler#rejectedExecution} method of its {@link
 * java.util.concurrent.RejectedExecutionHandler}.  Four predefined handler policies are
 * provided:
 *
 * <ol>
 *
...
public class ThreadPoolExecutor extends java.util.concurrent.AbstractExecutorService {
     ...
     * holding mainLock.
     */
    private final java.util.HashSet<Worker> workers = new java.util.HashSet<Worker>();
     ...
     */
    private java.util.List<Runnable> drainQueue() {
        java.util.concurrent.BlockingQueue<Runnable> q = workQueue;
        java.util.List<Runnable> taskList = new java.util.ArrayList<Runnable>();
        q.drainTo(taskList);
        if (!q.isEmpty()) {
    ...
    public ThreadPoolExecutor(int corePoolSize,
        ...
        this(corePoolSize, maximumPoolSize, keepAliveTime, unit, workQueue,
             java.util.concurrent.Executors.defaultThreadFactory(), defaultHandler);
    }
    ...
    public ThreadPoolExecutor(int corePoolSize,
        ...
        this(corePoolSize, maximumPoolSize, keepAliveTime, unit, workQueue,
             java.util.concurrent.Executors.defaultThreadFactory(), handler);
    }
    ...
    public long getKeepAliveTime(java.util.concurrent.TimeUnit unit) {
        return unit.convert(keepAliveTime, java.util.concurrent.TimeUnit.NANOSECONDS);
    }
     ...
     */
    public void purge() {
        final java.util.concurrent.BlockingQueue<Runnable> q = workQueue;
        try {
        ...
        } catch (java.util.ConcurrentModificationException fallThrough) {
