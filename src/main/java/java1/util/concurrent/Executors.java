...
public class Executors {
     ...
     * @throws IllegalArgumentException if {@code nThreads <= 0}
     */
    public static java.util.concurrent.ExecutorService newFixedThreadPool(int nThreads, java.util.concurrent.ThreadFactory threadFactory) {
        return new java.util.concurrent.ThreadPoolExecutor(nThreads, nThreads,
                                      0L, java.util.concurrent.TimeUnit.MILLISECONDS,
                                      new java.util.concurrent.LinkedBlockingQueue<Runnable>(),
                                      threadFactory);
    ...
    public static java.util.concurrent.ScheduledExecutorService newSingleThreadScheduledExecutor(java.util.concurrent.ThreadFactory threadFactory) {
        return new DelegatedScheduledExecutorService
            (new java.util.concurrent.ScheduledThreadPoolExecutor(1, threadFactory));
    }
     ...
     * {@link java.util.concurrent.ThreadPoolExecutor#beforeExecute}. Also, if it is
     ...
     */
    static final class RunnableAdapter<T> implements java.util.concurrent.Callable<T> {
        final Runnable task;
        final T result;
     ...
     */
    static final class PrivilegedCallable<T> implements java.util.concurrent.Callable<T> {
     ...
     * current ClassLoader
     */
    static final class PrivilegedCallableUsingCurrentClassLoader<T> implements java.util.concurrent.Callable<T> {
        private final java.util.concurrent.Callable<T> task;
        private final AccessControlContext acc;
    ...
    static class DelegatedExecutorService extends java.util.concurrent.AbstractExecutorService {
        ...
        public java.util.List<Runnable> shutdownNow() { return e.shutdownNow(); }
    ...
    static class DelegatedScheduledExecutorService
        ...
        public java.util.concurrent.ScheduledFuture<?> schedule(Runnable command, long delay,  java.util.concurrent.TimeUnit unit) {
        ...
        public java.util.concurrent.ScheduledFuture<?> scheduleWithFixedDelay(Runnable command, long initialDelay,  long delay, java.util.concurrent.TimeUnit unit) {
