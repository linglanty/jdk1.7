...
public class ConcurrentSkipListMap<K,V> extends java.util.AbstractMap<K,V>
     ...
     */
    private static final java.util.Random seedGenerator = new java.util.Random();
    ...
    static final class Node<K,V> {
        ...
        java.util.AbstractMap.SimpleImmutableEntry<K,V> createSnapshot() {
            ...
            if (v == null)
                return null;
            return new java.util.AbstractMap.SimpleImmutableEntry<K,V>(key, v);
        }
    ...
    static final class ComparableUsingComparator<K> implements Comparable<K> {
        ...
        ComparableUsingComparator(K key, java.util.Comparator<? super K> cmp) {
            this.actualKey = key;
            this.cmp = cmp;
        }
    ...
    int compare(K k1, K k2) throws ClassCastException {
        java.util.Comparator<? super K> cmp = comparator;
        if (cmp != null)
     ...
     */
    java.util.Map.Entry<K,V> doRemoveFirstEntry() {
        for (;;) {
            Node<K,V> b = head.node;
            Node<K,V> n = b.next;
            if (n == null)
            ...
            if (!n.appendMarker(f) || !b.casNext(n, f))
                findFirst(); // retry
            clearIndexToFirst();
            return new java.util.AbstractMap.SimpleImmutableEntry<K,V>(n.key, (V)v);
        }
    }
    ...
    java.util.Map.Entry<K,V> doRemoveLastEntry() {
        for (;;) {
            ...
            for (;;) {
                ...
                return new java.util.AbstractMap.SimpleImmutableEntry<K,V>(key, (V)v);
            }
        }
    }
     ...
     */
    java.util.AbstractMap.SimpleImmutableEntry<K,V> getNear(K key, int rel) {
        for (;;) {
            Node<K,V> n = findNear(key, rel);
            if (n == null)
                return null;
            java.util.AbstractMap.SimpleImmutableEntry<K,V> e = n.createSnapshot();
            if (e != null)
                return e;
        }
    }
    ...
    private void buildFromSorted(java.util.SortedMap<K, ? extends V> map) {
        ...
        java.util.ArrayList<Index<K,V>> preds = new java.util.ArrayList<Index<K,V>>();
        ...
        java.util.Iterator<? extends java.util.Map.Entry<? extends K, ? extends V>> it =
            map.entrySet().iterator();
        while (it.hasNext()) {
            java.util.Map.Entry<? extends K, ? extends V> e = it.next();
            int j = randomLevel();
     ...
     */
    abstract class Iter<T> implements java.util.Iterator<T> {
    ...
    final class EntryIterator extends Iter<java.util.Map.Entry<K,V>> {
        public java.util.Map.Entry<K,V> next() {
            Node<K,V> n = next;
            V v = nextValue;
            advance();
            return new java.util.AbstractMap.SimpleImmutableEntry<K,V>(n.key, v);
        }
    }
    ...
    static final <E> java.util.List<E> toList(java.util.Collection<E> c) {
    ...
    static final class KeySet<E>
            extends java.util.AbstractSet<E> implements java.util.NavigableSet<E> {
    ...
    static final class Values<E> extends java.util.AbstractCollection<E> {
    ...
    static final class EntrySet<K1,V1> extends java.util.AbstractSet<java.util.Map.Entry<K1,V1>> {
        ...
        public boolean contains(Object o) {
            if (!(o instanceof java.util.Map.Entry))
                return false;
            java.util.Map.Entry<K1,V1> e = (java.util.Map.Entry<K1,V1>)o;
            V1 v = m.get(e.getKey());
     ...
     * @serial include
     */
    static final class SubMap<K,V> extends java.util.AbstractMap<K,V>
        ...
        private java.util.Map.Entry<K,V> lowestEntry() {
            for (;;) {
                ConcurrentSkipListMap.Node<K,V> n = loNode();
                if (!isBeforeEnd(n))
                    return null;
                java.util.Map.Entry<K,V> e = n.createSnapshot();
                if (e != null)
                    return e;
            }
        }

        private java.util.Map.Entry<K,V> highestEntry() {
            for (;;) {
                ConcurrentSkipListMap.Node<K,V> n = hiNode();
        ...
        private java.util.Map.Entry<K,V> removeLowest() {
            for (;;) {
                Node<K,V> n = loNode();
                if (n == null)
                    return null;
                ...
                if (v != null)
                    return new java.util.AbstractMap.SimpleImmutableEntry<K,V>(k, v);
            }
        }

        private java.util.Map.Entry<K,V> removeHighest() {
            for (;;) {
                Node<K,V> n = hiNode();
                if (n == null)
                    return null;
         ...
         */
        private java.util.Map.Entry<K,V> getNearEntry(K key, int rel) {
        ...
        public java.util.Comparator<? super K> comparator() {
            java.util.Comparator<? super K> cmp = m.comparator();
            if (isDescending)
        ...
        public java.util.Collection<V> values() {
            java.util.Collection<V> vs = valuesView;
            return (vs != null) ? vs : (valuesView = new Values(this));
        }

        public java.util.Set<java.util.Map.Entry<K,V>> entrySet() {
            java.util.Set<java.util.Map.Entry<K,V>> es = entrySetView;
         ...
         */
        abstract class SubMapIter<T> implements java.util.Iterator<T> {
            /** the last node returned by next() */
            Node<K,V> lastReturned;
            /** the next node to return from next(); */
            Node<K,V> next;
        ...
        final class SubMapEntryIterator extends SubMapIter<java.util.Map.Entry<K,V>> {
            public java.util.Map.Entry<K,V> next() {
                Node<K,V> n = next;
                V v = nextValue;
                advance();
