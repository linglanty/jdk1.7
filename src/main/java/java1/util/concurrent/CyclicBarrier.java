...
public class CyclicBarrier {
    ...
    private final java.util.concurrent.locks.Condition trip = lock.newCondition();
    ...
    private int dowait(boolean timed, long nanos)
        throws InterruptedException, java.util.concurrent.BrokenBarrierException, java.util.concurrent.TimeoutException {
     ...
     */
    public int await() throws InterruptedException, java.util.concurrent.BrokenBarrierException {
        try {
     ...
     * java.util.concurrent.BrokenBarrierException} and the barrier is placed in the broken
     * state.
     *
     * <p>If the current thread is the last thread to arrive, and a
     * non-null barrier action was supplied in the constructor, then the
     ...
     */
    public int await(long timeout, java.util.concurrent.TimeUnit unit)
        throws InterruptedException, java.util.concurrent.BrokenBarrierException, java.util.concurrent.TimeoutException {
