 ...
 * {@code byte}, {@link java.math.BigDecimal BigDecimal}, and {@link java.util.Calendar}
 * are supported.  Limited formatting customization for arbitrary user types is
 * provided through the {@link java.util.Formattable} interface.
 *
 ...
 * encoding a date or time: {@code long}, {@link Long}, {@link java.util.Calendar}, and
 * {@link java.util.Date}.
 *
 ...
 *     <td valign="top"> general
 *     <td> If the argument <i>arg</i> is {@code null}, then the result is
 *     "{@code null}".  If <i>arg</i> implements {@link java.util.Formattable}, then
 ...
 *     {@code long}, {@link Long}, and {@link java.util.Date} the time zone used is
 ...
 * </table>
 *
 * <p> <sup>1</sup> Depends on the definition of {@link java.util.Formattable}.
 *
 ...
 * cause an {@link java.util.UnknownFormatConversionException} or {@link
 ...
 * java.util.IllegalFormatWidthException} or {@link java.util.IllegalFormatPrecisionException}
 ...
 *
 *     <p> If the argument is {@code null}, then the result is
 *     "{@code null}".  If the argument implements {@link java.util.Formattable}, then
 ...
 *     java.util.Formattable} , then a {@link java.util.FormatFlagsConversionMismatchException}
 *     will be thrown.
 *
 * <tr><td valign="top"> {@code 'S'}
 ...
 *     java.util.MissingFormatWidthException} will be thrown.  If this flag is not given
 ...
 * {@code false} then an {@link java.util.IllegalFormatCodePointException} will be
 * thrown.
 *
 ...
 * {@link java.util.IllegalFormatPrecisionException} will be thrown.
 *
 ...
 *     are given then a {@link java.util.FormatFlagsConversionMismatchException} will be
 *     thrown.
 *
 ...
 *     then an {@link java.util.IllegalFormatFlagsException} will be thrown.
 *
 ...
 *     java.util.MissingFormatWidthException} will be thrown.
 *
 *     <p> If both the {@code '-'} and {@code '0'} flags are given then an
 *     {@link java.util.IllegalFormatFlagsException} will be thrown.
 *
 * <tr><td valign="top"> {@code ','}
 ...
 * java.util.Calendar}, and {@link java.util.Date}.
 *
 ...
 * {@link java.util.FormatFlagsConversionMismatchException} will be thrown.
 *
 ...
 * {@link java.util.IllegalFormatFlagsException}, {@link java.util.IllegalFormatWidthException},
 * and {@link java.util.IllegalFormatPrecisionException}, respectively will be thrown.
 *
 ...
 * argument, then a {@link java.util.MissingFormatArgumentException} is thrown.
 *
 * <blockquote><pre>
 ...
 * available argument, then a {@link java.util.MissingFormatArgumentException} is thrown.
 *
...
public final class Formatter implements Closeable, Flushable {
    ...
    private Formatter(java.util.Locale l, Appendable a) {
        this.a = a;
        this.l = l;
        this.zero = getZero(l);
    }

    private Formatter(Charset charset, java.util.Locale l, File file)
     ...
     */
    public Formatter() {
        this(java.util.Locale.getDefault(java.util.Locale.Category.FORMAT), new StringBuilder());
    }
    ...
    public Formatter(Appendable a) {
        this(java.util.Locale.getDefault(java.util.Locale.Category.FORMAT), nonNullAppendable(a));
    }
     ...
     *         is applied.
     */
    public Formatter(Appendable a, java.util.Locale l) {
    ...
    public Formatter(String fileName) throws FileNotFoundException {
        this(java.util.Locale.getDefault(java.util.Locale.Category.FORMAT),
    ...
    {
        this(fileName, csn, java.util.Locale.getDefault(java.util.Locale.Category.FORMAT));
    }
    ...
    public Formatter(File file, String csn)
        throws FileNotFoundException, UnsupportedEncodingException
    {
        this(file, csn, java.util.Locale.getDefault(java.util.Locale.Category.FORMAT));
    }
     ...
     *          If the named charset is not supported
     */
    public Formatter(File file, String csn, java.util.Locale l)
        throws FileNotFoundException, UnsupportedEncodingException
    {
    ...
    public Formatter(OutputStream os, String csn)
        throws UnsupportedEncodingException
    {
        this(os, csn, java.util.Locale.getDefault(java.util.Locale.Category.FORMAT));
    }
     ...
     *          If the named charset is not supported
     */
    public Formatter(OutputStream os, String csn, java.util.Locale l)
        throws UnsupportedEncodingException
    {
        this(l, new BufferedWriter(new OutputStreamWriter(os, csn)));
    }

    private static char getZero(java.util.Locale l) {
        if ((l != null) && !l.equals(java.util.Locale.US)) {
     ...
     * @return  This formatter
     */
    public Formatter format(java.util.Locale l, String format, Object ... args) {
        ensureOpen();
            ...
            try {
                ...
                case -1:  // relative index
                    if (last < 0 || (args != null && last > args.length - 1))
                        throw new java.util.MissingFormatArgumentException(fs.toString());
    ...
    private FormatString[] parse(String s) {
        java.util.ArrayList<FormatString> al = new java.util.ArrayList<>();
    ...
    private interface FormatString {
        int index();
        void print(Object arg, java.util.Locale l) throws IOException;
        String toString();
    }
    ...
    private class FixedString implements FormatString {
        ...
        public void print(Object arg, java.util.Locale l)
    ...
    private class FormatSpecifier implements FormatString {
        ...
        public void print(Object arg, java.util.Locale l) throws IOException {
            if (dt) {
                printDateTime(arg, l);
                return;
            }
        ...
        private void printInteger(Object arg, java.util.Locale l) throws IOException {
            if (arg == null)
                print("null");
        ...
        private void printFloat(Object arg, java.util.Locale l) throws IOException {
            if (arg == null)
                print("null");
        ...
        private void printDateTime(Object arg, java.util.Locale l) throws IOException {
            if (arg == null) {
                print("null");
                return;
            }
            ...
            if (arg instanceof Long) {
                ...
                cal = java.util.Calendar.getInstance(l == null ? java.util.Locale.US : l);
                cal.setTimeInMillis((Long)arg);
            } else if (arg instanceof java.util.Date) {
                // Note that the following method uses an instance of the
                // default time zone (TimeZone.getDefaultRef().
                cal = java.util.Calendar.getInstance(l == null ? java.util.Locale.US : l);
                cal.setTime((java.util.Date)arg);
            } else if (arg instanceof java.util.Calendar) {
                cal = (java.util.Calendar) ((java.util.Calendar)arg).clone();
                cal.setLenient(true);
            } else {
                failConversion(c, arg);
            }
        ...
        private void printCharacter(Object arg) throws IOException {
            ...
            if (arg instanceof Character) {
                ...
                if (Character.isValidCodePoint(i))
                    ...
                    throw new java.util.IllegalFormatCodePointException(i);
            } else if (arg instanceof Short) {
        ...
        private void printString(Object arg, java.util.Locale l) throws IOException {
            if (arg instanceof java.util.Formattable) {
                Formatter fmt = Formatter.this;
                if (fmt.locale() != l)
                    fmt = new Formatter(fmt.out(), l);
                ((java.util.Formattable)arg).formatTo(fmt, f.valueOf(), width, precision);
            } else {
        ...
        private void checkGeneral() {
            ...
            if (width == -1 && f.contains(Flags.LEFT_JUSTIFY))
                throw new java.util.MissingFormatWidthException(toString());
        ...
        private void checkDateTime() {
            ...
            if (!DateTime.isValid(c))
                throw new java.util.UnknownFormatConversionException("t" + c);
        ...
        private void checkNumeric() {
            ...
            if ((f.contains(Flags.PLUS) && f.contains(Flags.LEADING_SPACE))
                || (f.contains(Flags.LEFT_JUSTIFY) && f.contains(Flags.ZERO_PAD)))
                throw new java.util.IllegalFormatFlagsException(f.toString());
        }
        ...
        private void print(byte value, java.util.Locale l) throws IOException {
            long v = value;
            if (value < 0
        ...
        private void print(short value, java.util.Locale l) throws IOException {
            long v = value;
            if (value < 0
                && (c == Conversion.OCTAL_INTEGER
                    || c == Conversion.HEXADECIMAL_INTEGER)) {
        ...
        private void print(int value, java.util.Locale l) throws IOException {
            long v = value;
            if (value < 0
                && (c == Conversion.OCTAL_INTEGER
                    || c == Conversion.HEXADECIMAL_INTEGER)) {
        ...
        private void print(long value, java.util.Locale l) throws IOException {
        ...
        private void print(BigInteger value, java.util.Locale l) throws IOException {
            StringBuilder sb = new StringBuilder();
        ...
        private void print(float value, java.util.Locale l) throws IOException {
            print((double) value, l);
        }

        private void print(double value, java.util.Locale l) throws IOException {
            StringBuilder sb = new StringBuilder();
        ...
        private void print(StringBuilder sb, double value, java.util.Locale l,
            ...
            throws IOException
        {
            if (c == Conversion.SCIENTIFIC) {
                ...
                if (upper) {
                    ...
                    // don't localize hex
                    tmp = tmp.toUpperCase(java.util.Locale.US);
                    va = tmp.toCharArray();
                }
        ...
        private void print(BigDecimal value, java.util.Locale l) throws IOException {
        ...
        // value > 0
        private void print(StringBuilder sb, BigDecimal value, java.util.Locale l,
                           Flags f, char c, int precision, boolean neg)
            throws IOException
        {
            if (c == Conversion.SCIENTIFIC) {
        ...
        private void print(java.util.Calendar t, char c, java.util.Locale l)  throws IOException
        {
            StringBuilder sb = new StringBuilder();
            print(sb, t, c, l);
        ...
        private Appendable print(StringBuilder sb, java.util.Calendar t, char c,
                                 java.util.Locale l)
            throws IOException
        {
            assert(width == -1);
            ...
            case DateTime.HOUR:        { // 'l' (1 - 12) -- like I
                int i = t.get(java.util.Calendar.HOUR_OF_DAY);
            ...
            case DateTime.MINUTE:      { // 'M' (00 - 59)
                int i = t.get(java.util.Calendar.MINUTE);
                Flags flags = Flags.ZERO_PAD;
                sb.append(localizedMagnitude(null, i, flags, 2, l));
                break;
            }
            case DateTime.NANOSECOND:  { // 'N' (000000000 - 999999999)
                int i = t.get(java.util.Calendar.MILLISECOND) * 1000000;
                Flags flags = Flags.ZERO_PAD;
                sb.append(localizedMagnitude(null, i, flags, 9, l));
                break;
            }
            case DateTime.MILLISECOND: { // 'L' (000 - 999)
                int i = t.get(java.util.Calendar.MILLISECOND);
                Flags flags = Flags.ZERO_PAD;
            ...
            case DateTime.AM_PM:       { // 'p' (am or pm)
                ...
                String[] ampm = { "AM", "PM" };
                if (l != null && l != java.util.Locale.US) {
                    DateFormatSymbols dfs = DateFormatSymbols.getInstance(l);
                    ampm = dfs.getAmPmStrings();
                }
                String s = ampm[t.get(java.util.Calendar.AM_PM)];
                sb.append(s.toLowerCase(l != null ? l : java.util.Locale.US));
                break;
            }
            ...
            case DateTime.SECOND:      { // 'S' (00 - 60 - leap second)
                int i = t.get(java.util.Calendar.SECOND);
                Flags flags = Flags.ZERO_PAD;
                sb.append(localizedMagnitude(null, i, flags, 2, l));
                break;
            }
            case DateTime.ZONE_NUMERIC: { // 'z' ({-|+}####) - ls minus?
                int i = t.get(java.util.Calendar.ZONE_OFFSET) + t.get(java.util.Calendar.DST_OFFSET);
                boolean neg = i < 0;
                sb.append(neg ? '-' : '+');
                if (neg)
                    i = -i;
            ...
            case DateTime.ZONE:        { // 'Z' (symbol)
                ...
                sb.append(tz.getDisplayName((t.get(java.util.Calendar.DST_OFFSET) != 0),
                                           java.util.TimeZone.SHORT,
                                            (l == null) ? java.util.Locale.US : l));
                break;
            }
            ...
            case DateTime.NAME_OF_DAY:          { // 'A'
                int i = t.get(java.util.Calendar.DAY_OF_WEEK);
                java.util.Locale lt = ((l == null) ? java.util.Locale.US : l);
            ...
            case DateTime.NAME_OF_MONTH:        { // 'B'
                int i = t.get(java.util.Calendar.MONTH);
                java.util.Locale lt = ((l == null) ? java.util.Locale.US : l);
                DateFormatSymbols dfs = DateFormatSymbols.getInstance(lt);
            ...
            case DateTime.YEAR_4:               { // 'Y' (0000 - 9999)
                int i = t.get(java.util.Calendar.YEAR);
                int size = 2;
                switch (c) {
            ...
            case DateTime.DAY_OF_MONTH:         { // 'e' (1 - 31) -- like d
                int i = t.get(java.util.Calendar.DATE);
            ...
            case DateTime.DAY_OF_YEAR:          { // 'j' (001 - 366)
                int i = t.get(java.util.Calendar.DAY_OF_YEAR);
                Flags flags = Flags.ZERO_PAD;
                sb.append(localizedMagnitude(null, i, flags, 3, l));
                break;
            }
            case DateTime.MONTH:                { // 'm' (01 - 12)
                int i = t.get(java.util.Calendar.MONTH) + 1;
                Flags flags = Flags.ZERO_PAD;
                sb.append(localizedMagnitude(null, i, flags, 2, l));
                break;
            }
            ...
            case DateTime.TIME_12_HOUR:    { // 'r' (hh:mm:ss [AP]M)
                ...
                sb.append(tsb.toString().toUpperCase(l != null ? l : java.util.Locale.US));
                break;
            }
        ...
        private void failMismatch(Flags f, char c) {
            ...
            throw new java.util.FormatFlagsConversionMismatchException(fs, c);
        }

        private void failConversion(char c, Object arg) {
            throw new java.util.IllegalFormatConversionException(c, arg.getClass());
        }

        private char getZero(java.util.Locale l) {
    ...
    private static class Flags {
        ...
        public static Flags parse(String s) {
            ...
            for (int i = 0; i < ca.length; i++) {
                Flags v = parse(ca[i]);
                if (f.contains(v))
                    throw new java.util.DuplicateFormatFlagsException(v.toString());
                f.add(v);
            }
            return f;
        }
        ...
        private static Flags parse(char c) {
            ...
            default:
                throw new java.util.UnknownFormatFlagsException(String.valueOf(c));
            }
        }
