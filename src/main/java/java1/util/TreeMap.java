    ...
    implements java.util.NavigableMap<K,V>, Cloneable, java.io.Serializable
{
     ...
     * @throws java.util.NoSuchElementException if the Entry is null
     */
    ...
    abstract static class NavigableSubMap<K,V> extends java.util.AbstractMap<K,V>
        ...
        abstract class EntrySetView extends java.util.AbstractSet<Map.Entry<K,V>> {
    ...
    static final class DescendingSubMap<K,V>  extends NavigableSubMap<K,V> {
        ...
        private final java.util.Comparator<? super K> reverseComparator =
            java.util.Collections.reverseOrder(m.comparator);
     ...
     * @serial include
     */
    private class SubMap extends java.util.AbstractMap<K,V>
        ...
        public java.util.Set<Map.Entry<K,V>> entrySet() { throw new InternalError(); }
        ...
        public java.util.SortedMap<K,V> tailMap(K fromKey) { throw new InternalError(); }
    ...
    void addAllForTreeSet(java.util.SortedSet<? extends K> set, V defaultVal) {
        try {
