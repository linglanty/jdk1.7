...
public final class PosixFilePermissions {
     ...
     */
    public static String toString(java.util.Set<PosixFilePermission> perms) {
     ...
     *
     * @see #toString(java.util.Set)
     */
    public static java.util.Set<PosixFilePermission> fromString(String perms) {
        if (perms.length() != 9)
            throw new IllegalArgumentException("Invalid mode");
        java.util.Set<PosixFilePermission> result = java.util.EnumSet.noneOf(PosixFilePermission.class);
    ...
    public static FileAttribute<java.util.Set<PosixFilePermission>>
        asFileAttribute(java.util.Set<PosixFilePermission> perms)
    {
        // copy set and check for nulls (CCE will be thrown if an element is not
        // a PosixFilePermission)
        perms = new java.util.HashSet<PosixFilePermission>(perms);
        for (PosixFilePermission p: perms) {
            if (p == null)
                throw new NullPointerException();
        }
        final java.util.Set<PosixFilePermission> value = perms;
        return new FileAttribute<java.util.Set<PosixFilePermission>>() {
            @Override
            public String name() {
                return "posix:permissions";
            }
            @Override
            public java.util.Set<PosixFilePermission> value() {
                return java.util.Collections.unmodifiableSet(value);
            }
        };
    }
}
