...
public final class AclEntry {
    ...
    private final java.util.Set<AclEntryPermission> perms;
    private final java.util.Set<AclEntryFlag> flags;
    ...
    private AclEntry(AclEntryType type,
                     UserPrincipal who,
                     java.util.Set<AclEntryPermission> perms,
                     java.util.Set<AclEntryFlag> flags)
    {
        this.type = type;
        this.who = who;
        this.perms = perms;
    ...
    public static final class Builder {
        ...
        private java.util.Set<AclEntryPermission> perms;
        private java.util.Set<AclEntryFlag> flags;
        ...
        private static void checkSet(java.util.Set<?> set, Class<?> type) {
            for (Object e: set) {
                if (e == null)
                    throw new NullPointerException();
                type.cast(e);
         ...
         *          AclEntryPermission}
         */
        public Builder setPermissions(java.util.Set<AclEntryPermission> perms) {
            // copy and check for erroneous elements
            perms = java.util.EnumSet.copyOf(perms);
        ...
        public Builder setPermissions(AclEntryPermission... perms) {
            java.util.Set<AclEntryPermission> set = java.util.EnumSet.noneOf(AclEntryPermission.class);
         ...
         *          AclEntryFlag}
         */
        public Builder setFlags(java.util.Set<AclEntryFlag> flags) {
            // copy and check for erroneous elements
        ...
        public Builder setFlags(AclEntryFlag... flags) {
            java.util.Set<AclEntryFlag> set = java.util.EnumSet.noneOf(AclEntryFlag.class);
            // copy and check for null elements
    ...
    public static Builder newBuilder() {
        java.util.Set<AclEntryPermission> perms = java.util.Collections.emptySet();
        java.util.Set<AclEntryFlag> flags = java.util.Collections.emptySet();
    ...
    public java.util.Set<AclEntryPermission> permissions() {
        return new java.util.HashSet<AclEntryPermission>(perms);
    }
    ...
    public java.util.Set<AclEntryFlag> flags() {
        return new java.util.HashSet<AclEntryFlag>(flags);
    }
