...
public interface Formattable {
     ...
     *         {@link java.util.Formatter#out() formatter.out()} or {@link
     *         java.util.Formatter#locale() formatter.locale()} to obtain the {@link
     ...
     *         java.util.FormattableFlags#ALTERNATE}.  If no flags are set, the default
     ...
     *         the {@link java.util.FormattableFlags#LEFT_JUSTIFY} flag is set then the
