...
abstract public class TimeZone implements Serializable, Cloneable {
    ...
    public int getOffset(long date) {
        if (inDaylightTime(new java.util.Date(date))) {
     ...
     * java.util.ResourceBundle.Control#getCandidateLocales(String, Locale) default
     * <code>Locale</code> search path of <code>ResourceBundle</code>} derived
     * from the specified {@code locale} is used. (No {@linkplain
     * java.util.ResourceBundle.Control#getFallbackLocale(String, Locale) fallback
     ...
     * required, construct a {@link java.util.Calendar} with this {@code
     * TimeZone} and the time stamp, and call {@link java.util.Calendar#get(int)
     * Calendar.get}{@code (}{@link java.util.Calendar#DST_OFFSET}{@code )}.
     *
     * @return the amount of saving time in milliseconds
     * @since 1.4
     * @see #inDaylightTime(java.util.Date)
     * @see #getOffset(long)
    ...
    public boolean observesDaylightTime() {
        return useDaylightTime() || inDaylightTime(new java.util.Date());
    }
     ...
     *         {@code false}, otherwise.
     */
    abstract public boolean inDaylightTime(java.util.Date date);
    ...
    private static boolean hasPermission() {
        ...
        if (sm != null) {
            try {
                sm.checkPermission(new java.util.PropertyPermission
                                   ("user.timezone", "write"));
