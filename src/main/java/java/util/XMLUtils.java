...
class XMLUtils {
    ...
    static void load(java.util.Properties props, InputStream in)
    ...
    static void importProperties(java.util.Properties props, Element propertiesElement) {
    ...
    static void save(java.util.Properties props, OutputStream os, String comment,
                     String encoding)
        throws IOException
    {
        DocumentBuilderFactory dbf = DocumentBuilderFactory.newInstance();
