...
//    }
    ...
    public static void sort(Object[] a) {
        if (LegacyMergeSort.userRequested)
            ...
            java.util.ComparableTimSort.sort(a);
    }
    ...
    public static void sort(Object[] a, int fromIndex, int toIndex) {
        if (LegacyMergeSort.userRequested)
            ...
            java.util.ComparableTimSort.sort(a, fromIndex, toIndex);
    }
    ...
    public static <T> void sort(T[] a, int fromIndex, int toIndex,
        ...
        if (LegacyMergeSort.userRequested)
            ...
            java.util.TimSort.sort(a, fromIndex, toIndex, c);
    }
     ...
     * {@link #sort(Object[], java.util.Comparator) sort(T[], Comparator)}
     ...
     * The range must be sorted into ascending order
     * according to the specified comparator (as by the
     * {@link #sort(Object[], int, int, java.util.Comparator)
    ...
    public static <T> int binarySearch(T[] a, int fromIndex, int toIndex,
                                       T key, java.util.Comparator<? super T> c) {
        rangeCheck(a.length, fromIndex, toIndex);
     ...
     * combination with {@link java.util.Collection#toArray}.  The returned list is
    ...
    public static String deepToString(Object[] a) {
        ...
        deepToString(a, buf, new java.util.HashSet<Object[]>());
        return buf.toString();
    }

    private static void deepToString(Object[] a, StringBuilder buf,
                                     java.util.Set<Object[]> dejaVu) {
        if (a == null) {
            buf.append("null");
            return;
        }
