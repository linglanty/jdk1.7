 ...
 * chaotic ordering provided by {@link java.util.HashMap} (and {@link java.util.Hashtable}),
 * without incurring the increased cost associated with {@link java.util.TreeMap}.  It
    ...
    implements Map<K,V>
{
    ...
    java.util.Iterator<Map.Entry<K,V>> newEntryIterator() { return new EntryIterator(); }
    ...
    void createEntry(int hash, K key, V value, int bucketIndex) {
        java.util.HashMap.Entry<K,V> old = table[bucketIndex];
