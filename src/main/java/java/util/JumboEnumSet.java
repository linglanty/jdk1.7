 ...
 * @serial exclude
 */
class JumboEnumSet<E extends Enum<E>> extends java.util.EnumSet<E> {
    ...
    private class EnumSetIterator<E extends Enum<E>> implements java.util.Iterator<E> {
        /**
    ...
    public boolean equals(Object o) {
        ...
        return java.util.Arrays.equals(es.elements, elements);
    }
