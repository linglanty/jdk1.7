 ...
 * will throw a {@link java.util.ConcurrentModificationException}.  Thus, in the
    ...
    implements Map<K,V>, java.io.Serializable, Cloneable
{
    ...
    private abstract class IdentityHashMapIterator<T> implements java.util.Iterator<T> {
    ...
    private class KeySet extends java.util.AbstractSet<K> {
        ...
        public boolean removeAll(java.util.Collection<?> c) {
            ...
            for (java.util.Iterator<K> i = iterator(); i.hasNext(); ) {
    ...
    private class Values extends java.util.AbstractCollection<V> {
        ...
        public boolean remove(Object o) {
            for (java.util.Iterator<V> i = iterator(); i.hasNext(); ) {
                if (i.next() == o) {
                    i.remove();
                    return true;
                }
    ...
    private class EntrySet extends java.util.AbstractSet<Map.Entry<K,V>> {
        ...
        public boolean removeAll(java.util.Collection<?> c) {
            boolean modified = false;
            for (java.util.Iterator<Map.Entry<K,V>> i = iterator(); i.hasNext(); ) {
                if (c.contains(i.next())) {
                    i.remove();
                    modified = true;
                }
        ...
        public Object[] toArray() {
            ...
            for (int i = 0; i < size; i++)
                result[i] = new SimpleEntry<>(it.next());
            return result;
        }
