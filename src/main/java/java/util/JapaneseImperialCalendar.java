 ...
 * java.util.GregorianCalendar}, the Julian to Gregorian transition is not
...
class JapaneseImperialCalendar extends java.util.Calendar {
    ...
    static {
        ...
        CalendarDate date = gcal.newCalendarDate(java.util.TimeZone.NO_TIMEZONE);
     ...
     */
    public JapaneseImperialCalendar(java.util.TimeZone zone, Locale aLocale) {
        super(zone, aLocale);
    ...
    public String getDisplayName(int field, int style, Locale locale) {
        ...
        java.util.ResourceBundle rb = LocaleData.getDateFormatData(locale);
        String name = null;
    ...
    public java.util.Map<String,Integer> getDisplayNames(int field, int style, Locale locale) {
    ...
    private java.util.Map<String,Integer> getDisplayNamesImpl(int field, int style, Locale locale) {
        java.util.ResourceBundle rb = LocaleData.getDateFormatData(locale);
        String key = getKey(field, style);
     ...
     * and {@link java.util.Calendar#getTimeZone() getTimeZone} methods.
     *
     * @param field the calendar field.
        ...
        case DAY_OF_YEAR:
            {
                if (isTransitionYear(date.getNormalizedYear())) {
                    ...
                    long transition = sinceFixedDates[eraIndex];
                    long fd = jc.cachedFixedDate;
                    CalendarDate d = gcal.newCalendarDate(java.util.TimeZone.NO_TIMEZONE);
    ...
    private long getFixedDate(int era, int year, int fieldMask) {
        ...
        LocalGregorianCalendar.Date date = jcal.newCalendarDate(java.util.TimeZone.NO_TIMEZONE);
    ...
    private static final LocalGregorianCalendar.Date getCalendarDate(long fd) {
        LocalGregorianCalendar.Date d = jcal.newCalendarDate(java.util.TimeZone.NO_TIMEZONE);
        jcal.getCalendarDateFromFixedDate(d, fd);
        return d;
    }
    ...
    private final int monthLength(int month, int gregorianYear) {
        return CalendarUtils.isGregorianLeapYear(gregorianYear) ?
            java.util.GregorianCalendar.LEAP_MONTH_LENGTH[month] : java.util.GregorianCalendar.MONTH_LENGTH[month];
    }
