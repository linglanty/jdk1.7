...
public class CopyOnWriteArrayList<E>
    ...
    transient final java.util.concurrent.locks.ReentrantLock lock = new java.util.concurrent.locks.ReentrantLock();
    ...
    public CopyOnWriteArrayList(java.util.Collection<? extends E> c) {
        ...
        if (elements.getClass() != Object[].class)
            elements = java.util.Arrays.copyOf(elements, elements.length, Object[].class);
        setArray(elements);
    }
    ...
    public CopyOnWriteArrayList(E[] toCopyIn) {
        setArray(java.util.Arrays.copyOf(toCopyIn, toCopyIn.length, Object[].class));
    }
    ...
    public <T> T[] toArray(T a[]) {
        ...
        if (a.length < len)
            return (T[]) java.util.Arrays.copyOf(elements, len, a.getClass());
        else {
    ...
    public E set(int index, E element) {
        ...
        try {
            ...
            if (oldValue != element) {
                int len = elements.length;
                Object[] newElements = java.util.Arrays.copyOf(elements, len);
    ...
    public boolean add(E e) {
        ...
        try {
            Object[] elements = getArray();
            int len = elements.length;
            Object[] newElements = java.util.Arrays.copyOf(elements, len + 1);
            newElements[len] = e;
            setArray(newElements);
            return true;
        } finally {
    ...
    public E remove(int index) {
        ...
        try {
            ...
            if (numMoved == 0)
                setArray(java.util.Arrays.copyOf(elements, len - 1));
            else {
    ...
    private void removeRange(int fromIndex, int toIndex) {
        ...
        try {
            ...
            if (numMoved == 0)
                setArray(java.util.Arrays.copyOf(elements, newlen));
            else {
                Object[] newElements = new Object[newlen];
    ...
    public boolean removeAll(java.util.Collection<?> c) {
        ...
        try {
            ...
            if (len != 0) {
                ...
                if (newlen != len) {
                    setArray(java.util.Arrays.copyOf(temp, newlen));
                    return true;
                }
            }
            return false;
    ...
    public int addAllAbsent(java.util.Collection<? extends E> c) {
        ...
        try {
            ...
            if (added > 0) {
                Object[] newElements = java.util.Arrays.copyOf(elements, len + added);
    ...
    public boolean addAll(java.util.Collection<? extends E> c) {
        ...
        try {
            Object[] elements = getArray();
            int len = elements.length;
            Object[] newElements = java.util.Arrays.copyOf(elements, len + cs.length);
    ...
    private static class COWIterator<E> implements java.util.ListIterator<E> {
        ...
        implements java.util.RandomAccess
    {
        ...
        public E set(int index, E element) {
            final java.util.concurrent.locks.ReentrantLock lock = l.lock;
            lock.lock();
            try {
                rangeCheck(index);
    ...
    private static class COWSubListIterator<E> implements java.util.ListIterator<E> {
        private final java.util.ListIterator<E> i;
        private final int index;
        private final int offset;
        private final int size;

        COWSubListIterator(java.util.List<E> l, int index, int offset,
                           int size) {
            this.index = index;
            this.offset = offset;
            this.size = size;
    ...
    private void resetLock() {
        UNSAFE.putObjectVolatile(this, lockOffset, new java.util.concurrent.locks.ReentrantLock());
    }
