...
public abstract class AbstractQueuedLongSynchronizer
    ...
    */
    ...
    private void unparkSuccessor(Node node) {
        ...
        if (s != null)
            java.util.concurrent.locks.LockSupport.unpark(s.thread);
    }
        ...
        try {
            for (;;) {
                ...
                if (shouldParkAfterFailedAcquire(p, node) &&
                    ...
                    java.util.concurrent.locks.LockSupport.parkNanos(this, nanosTimeout);
     ...
     * to implement method {@link java.util.concurrent.locks.Lock#tryLock()}.
     *
     * <p>The default
     ...
     * method {@link java.util.concurrent.locks.Lock#tryLock(long, java.util.concurrent.TimeUnit)}.
     *
     * @param arg the acquire argument.  This value is conveyed to
     *        {@link #tryAcquire} but is otherwise uninterpreted and
     *        can represent anything you like.
    ...
    public final java.util.Collection<Thread> getQueuedThreads() {
        java.util.ArrayList<Thread> list = new java.util.ArrayList<Thread>();
        for (Node p = tail; p != null; p = p.prev) {
            Thread t = p.thread;
            if (t != null)
                list.add(t);
     ...
     * @throws NullPointerException if the condition is null
     */
    public final java.util.Collection<Thread> getWaitingThreads(ConditionObject condition) {
        if (!owns(condition))
            throw new IllegalArgumentException("Not owner");
    ...
    public class ConditionObject implements java.util.concurrent.locks.Condition, java.io.Serializable {
        ...
        public final boolean awaitUntil(java.util.Date deadline)
            ...
            while (!isOnSyncQueue(node)) {
                ...
                java.util.concurrent.locks.LockSupport.parkUntil(this, abstime);
                if ((interruptMode = checkInterruptWhileWaiting(node)) != 0)
                    break;
            }
            if (acquireQueued(node, savedState) && interruptMode != THROW_IE)
