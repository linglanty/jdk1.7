 ...
 * queue. The {@link java.util.concurrent.ExecutorCompletionService} class provides an
...
public interface CompletionService<V> {
     ...
     * @throws NullPointerException if the task is null
     */
    java.util.concurrent.Future<V> submit(Runnable task, V result);
     ...
     */
    java.util.concurrent.Future<V> take() throws InterruptedException;
     ...
     * @throws InterruptedException if interrupted while waiting
     */
    java.util.concurrent.Future<V> poll(long timeout, java.util.concurrent.TimeUnit unit) throws InterruptedException;
}
