 ...
 * java.util.concurrent.Executor#execute} by creating and returning a {@link java.util.concurrent.Future} that
 ...
 * java.util.concurrent.Executors#newFixedThreadPool} factory method:
 *
 * <pre>
...
public interface ExecutorService extends java.util.concurrent.Executor {
     ...
     * @throws NullPointerException if the task is null
     */
    <T> java.util.concurrent.Future<T> submit(Runnable task, T result);
     ...
     *         unit are <tt>null</tt>
     * @throws java.util.concurrent.RejectedExecutionException if any task cannot be scheduled
     *         for execution
     */
    <T> List<java.util.concurrent.Future<T>> invokeAll(Collection<? extends java.util.concurrent.Callable<T>> tasks,
     ...
     * @throws java.util.concurrent.ExecutionException if no task successfully completes
     * @throws java.util.concurrent.RejectedExecutionException if tasks cannot be scheduled
     *         for execution
     */
     ...
     * @throws java.util.concurrent.TimeoutException if the given timeout elapses before
