 ...
 * to a {@link java.util.concurrent.ForkJoinPool}.  Once started, it will usually in turn
 ...
 * additionally include {@link java.util.concurrent.RejectedExecutionException} stemming
 ...
 * {@link java.util.concurrent.RecursiveTask} for those that do.  Normally, a concrete
 ...
 * @author Doug Lea
 */
public abstract class ForkJoinTask<V> implements java.util.concurrent.Future<V>, Serializable {
     ...
     */
    private int doJoin() {
        Thread t; java.util.concurrent.ForkJoinWorkerThread w; int s; boolean completed;
        if ((t = Thread.currentThread()) instanceof java.util.concurrent.ForkJoinWorkerThread) {
            if ((s = status) < 0)
                return s;
            if ((w = (java.util.concurrent.ForkJoinWorkerThread)t).unpushTask(this)) {
                try {
                    completed = exec();
                } catch (Throwable rex) {
    ...
    public final ForkJoinTask<V> fork() {
        ((java.util.concurrent.ForkJoinWorkerThread) Thread.currentThread())
            .pushTask(this);
        return this;
    }
    ...
    public final Throwable getException() {
        ...
        return ((s >= NORMAL)    ? null :
                (s == CANCELLED) ? new java.util.concurrent.CancellationException() :
     ...
     */
    public final V get() throws InterruptedException, java.util.concurrent.ExecutionException {
     ...
     */
    public final V get(long timeout, java.util.concurrent.TimeUnit unit)
     ...
     * {@link java.util.concurrent.ForkJoinPool#isQuiescent is quiescent}. This method may
    ...
    public static java.util.concurrent.ForkJoinPool getPool() {
        Thread t = Thread.currentThread();
        return (t instanceof java.util.concurrent.ForkJoinWorkerThread) ?
            ((java.util.concurrent.ForkJoinWorkerThread) t).pool : null;
    }

    /**
     * Returns {@code true} if the current thread is a {@link
     * java.util.concurrent.ForkJoinWorkerThread} executing as a ForkJoinPool computation.
     *
    ...
    public static boolean inForkJoinPool() {
        return Thread.currentThread() instanceof java.util.concurrent.ForkJoinWorkerThread;
    }
    ...
    public boolean tryUnfork() {
        return ((java.util.concurrent.ForkJoinWorkerThread) Thread.currentThread())
            .unpushTask(this);
    }
     ...
     * @return the task
     */
    public static <T> ForkJoinTask<T> adapt(java.util.concurrent.Callable<? extends T> callable) {
