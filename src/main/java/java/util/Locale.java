...
public final class Locale implements Cloneable, Serializable {
    ...
    public static Locale getDefault(Locale.Category category) {
        ...
        // it's OK if more than one default locale happens to be created
        switch (category) {
        case java.util.Locale.Category.DISPLAY:
            if (defaultDisplayLocale == null) {
                initDefault(category);
            }
            return defaultDisplayLocale;
        case java.util.Locale.Category.FORMAT:
    ...
    public static String[] getISOCountries() {
        if (isoCountries == null) {
            isoCountries = getISO2Table(java.util.LocaleISOData.isoCountryTable);
        }
    ...
    public static String[] getISOLanguages() {
        if (isoLanguages == null) {
            isoLanguages = getISO2Table(java.util.LocaleISOData.isoLanguageTable);
        }
    ...
    public String toLanguageTag() {
        ...
        java.util.List<String> subtags = tag.getVariants();
     ...
     */
    public String getISO3Language() throws java.util.MissingResourceException {
        String lang = baseLocale.getLanguage();
        if (lang.length() == 3) {
            return lang;
        }

        String language3 = getISO3Code(lang, java.util.LocaleISOData.isoLanguageTable);
        if (language3 == null) {
            throw new java.util.MissingResourceException("Couldn't find 3-letter language code for "
     ...
     */
    public String getISO3Country() throws java.util.MissingResourceException {
        String country3 = getISO3Code(baseLocale.getRegion(), java.util.LocaleISOData.isoCountryTable);
        if (country3 == null) {
            throw new java.util.MissingResourceException("Couldn't find 3-letter country code for "
    ...
    public String getDisplayName(Locale inLocale) {
        ...
        java.util.ArrayList<String> names = new java.util.ArrayList<>(4);
