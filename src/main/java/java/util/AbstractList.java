...
public abstract class AbstractList<E> extends java.util.AbstractCollection<E> implements java.util.List<E> {
    ...
    public java.util.List<E> subList(int fromIndex, int toIndex) {
        return (this instanceof java.util.RandomAccess ?
    ...
    public boolean equals(Object o) {
        ...
        java.util.ListIterator e2 = ((java.util.List) o).listIterator();
    ...
    protected void removeRange(int fromIndex, int toIndex) {
        java.util.ListIterator<E> it = listIterator(fromIndex);
...
class SubList<E> extends AbstractList<E> {
    ...
    public java.util.ListIterator<E> listIterator(final int index) {
        ...
        return new java.util.ListIterator<E>() {
            private final java.util.ListIterator<E> i = l.listIterator(index+offset);
...
class RandomAccessSubList<E> extends SubList<E> implements java.util.RandomAccess {
