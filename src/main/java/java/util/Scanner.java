 ...
 *
 * <p>When a scanner throws an {@link java.util.InputMismatchException}, the scanner
...
public final class Scanner implements Iterator<String>, Closeable {
    ...
    new LRUCache<String, java.util.regex.Pattern>(7) {
        protected java.util.regex.Pattern create(String s) {
            return java.util.regex.Pattern.compile(s);
        }
        protected boolean hasName(java.util.regex.Pattern p, String s) {
    ...
    private static java.util.regex.Pattern WHITESPACE_PATTERN = java.util.regex.Pattern.compile(
                                                "\\p{javaWhitespace}+");

    // A pattern for any token
    private static java.util.regex.Pattern FIND_ANY_PATTERN = java.util.regex.Pattern.compile("(?s).*");

    // A pattern for non-ASCII digits
    private static java.util.regex.Pattern NON_ASCII_DIGIT = java.util.regex.Pattern.compile(
        "[\\p{javaDigit}&&[^0-9]]");
    ...
    private static java.util.regex.Pattern boolPattern() {
        java.util.regex.Pattern bp = boolPattern;
        if (bp == null)
            boolPattern = bp = java.util.regex.Pattern.compile(BOOLEAN_PATTERN,
    ...
    private static java.util.regex.Pattern separatorPattern() {
        java.util.regex.Pattern sp = separatorPattern;
        if (sp == null)
            separatorPattern = sp = java.util.regex.Pattern.compile(LINE_SEPARATOR_PATTERN);
        return sp;
    }

    private static java.util.regex.Pattern linePattern() {
        java.util.regex.Pattern lp = linePattern;
        if (lp == null)
            linePattern = lp = java.util.regex.Pattern.compile(LINE_PATTERN);
        return lp;
    }
    ...
    private void buildFloatAndDecimalPattern() {
        ...
        String signedNonNumber = "(([-+]?"+nonNumber+")|" +
                                 positiveNonNumber + "|" +
                                 negativeNonNumber + ")";
        floatPattern = java.util.regex.Pattern.compile(decimal + "|" + hexFloat + "|" +
                                       signedNonNumber);
        decimalPattern = java.util.regex.Pattern.compile(decimal);
    }
    private java.util.regex.Pattern floatPattern() {
     ...
     */
    private Scanner(Readable source, java.util.regex.Pattern pattern) {
    ...
    public Scanner(Readable source) {
        this(java.util.Objects.requireNonNull(source, "source"), WHITESPACE_PATTERN);
    }
    ...
    public Scanner(InputStream source, String charsetName) {
        this(makeReadable(java.util.Objects.requireNonNull(source, "source"), toCharset(charsetName)),
             WHITESPACE_PATTERN);
    }
    ...
    {
        this(java.util.Objects.requireNonNull(source), toDecoder(charsetName));
    }
    ...
    private static CharsetDecoder toDecoder(String charsetName) {
        java.util.Objects.requireNonNull(charsetName, "charsetName");
        try {
    ...
    public Scanner(Path source, String charsetName) throws IOException {
        this(java.util.Objects.requireNonNull(source), toCharset(charsetName));
    }
    ...
    public Scanner(ReadableByteChannel source) {
        this(makeReadable(java.util.Objects.requireNonNull(source, "source")),
             WHITESPACE_PATTERN);
    }
    ...
    public Scanner(ReadableByteChannel source, String charsetName) {
        this(makeReadable(java.util.Objects.requireNonNull(source, "source"), toDecoder(charsetName)),
             WHITESPACE_PATTERN);
    }
     ...
     */
    private String getCompleteTokenInBuffer(java.util.regex.Pattern pattern) {
        matchValid = false;
    ...
    private String findPatternInBuffer(java.util.regex.Pattern pattern, int horizon) {
        matchValid = false;
        matcher.usePattern(pattern);
    ...
    private String matchPatternInBuffer(java.util.regex.Pattern pattern) {
        matchValid = false;
        matcher.usePattern(pattern);
        matcher.region(position, buf.limit());
        if (matcher.lookingAt()) {
     ...
     * @return this scanner
     */
    public Scanner useLocale(java.util.Locale locale) {
    ...
    public boolean hasNextLine() {
        ...
        if (result != null) {
            java.util.regex.MatchResult mr = this.match();
     ...
     * java.util.regex.Matcher#useTransparentBounds} and {@link java.util.regex.Matcher#useAnchoringBounds}).
     *
    ...
    public byte nextByte(int radix) {
        ...
        try {
            ...
            throw new java.util.InputMismatchException(nfe.getMessage());
        }
    }
    ...
    private String processFloatToken(String token) {
        ...
        java.util.regex.Matcher m = NON_ASCII_DIGIT.matcher(result);
        if (m.find()) {
