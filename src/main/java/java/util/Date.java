    ...
    implements java.io.Serializable, Cloneable, Comparable<Date>
{
    ...
    public Date(int year, int month, int date, int hrs, int min, int sec) {
        ...
        cdate = (BaseCalendar.Date) cal.newCalendarDate(java.util.TimeZone.getDefaultRef());
     ...
     * @see     java.text.DateFormat
     * @see     Date#parse(java.lang.String)
     * @deprecated As of JDK version 1.1,
    ...
    syntax:
        {
            ...
            if (tzoffset == -1)  { // no time zone specified, have to use local
                BaseCalendar.Date ldate = (BaseCalendar.Date) cal.newCalendarDate(java.util.TimeZone.getDefaultRef());
    ...
    public String toString() {
        ...
        java.util.TimeZone zi = date.getZone();
        if (zi != null) {
    ...
    public String toGMTString() {
        ...
        BaseCalendar.Date date =
            (BaseCalendar.Date) cal.getCalendarDate(getTime(), (java.util.TimeZone)null);
    ...
    public int getTimezoneOffset() {
        int zoneOffset;
        if (cdate == null) {
            java.util.TimeZone tz = java.util.TimeZone.getDefaultRef();
    ...
    private final BaseCalendar.Date normalize(BaseCalendar.Date date) {
        ...
        java.util.TimeZone tz = date.getZone();
        ...
        if (y == 1582 || y > 280000000 || y < -280000000) {
            ...
            java.util.GregorianCalendar gc = new java.util.GregorianCalendar(tz);
            gc.clear();
    ...
    private static final BaseCalendar getCalendarSystem(long utc) {
        ...
        if (utc >= 0
            || utc >= java.util.GregorianCalendar.DEFAULT_GREGORIAN_CUTOVER
                        - java.util.TimeZone.getDefaultRef().getOffset(utc)) {
            return gcal;
        }
        return getJulianCalendar();
    }
