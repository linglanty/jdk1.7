...
public class WeakHashMap<K,V>
    ...
    private abstract class HashIterator<T> implements java.util.Iterator<T> {
        private int index;
    ...
    private class EntrySet extends java.util.AbstractSet<Map.Entry<K,V>> {
        ...
        private java.util.List<Map.Entry<K,V>> deepCopy() {
            java.util.List<Map.Entry<K,V>> list = new java.util.ArrayList<>(size());
