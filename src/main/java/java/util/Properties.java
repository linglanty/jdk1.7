...
class Properties extends java.util.Hashtable<Object,Object> {
    ...
    public synchronized void loadFromXML(InputStream in)
        throws IOException, java.util.InvalidPropertiesFormatException
    {
        if (in == null)
            throw new NullPointerException();
        java.util.XMLUtils.load(this, in);
        in.close();
    }
        ...
        throws IOException
    {
        if (os == null)
            throw new NullPointerException();
        java.util.XMLUtils.save(this, os, comment, encoding);
    }
     ...
     */
    private synchronized void enumerate(java.util.Hashtable h) {
        if (defaults != null) {
     ...
     * @param h the hashtable
     */
    private synchronized void enumerateStringProperties(java.util.Hashtable<String, String> h) {
        if (defaults != null) {
