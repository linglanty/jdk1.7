 ...
 * #setGregorianChange(java.util.Date) setGregorianChange()}.
 *
 * <p>
 ...
 *
 * <p>Values calculated for the {@link java.util.Calendar#WEEK_OF_YEAR
 * WEEK_OF_YEAR} field range from 1 to 53. The first week of a
 * calendar year is the earliest seven day period starting on {@link
 * java.util.Calendar#getFirstDayOfWeek() getFirstDayOfWeek()} that contains at
 * least {@link java.util.Calendar#getMinimalDaysInFirstWeek()
 ...
 * {@link java.util.Calendar#setMinimalDaysInFirstWeek(int)
...
///////////////
    ...
    public GregorianCalendar() {
        this(java.util.TimeZone.getDefaultRef(), Locale.getDefault(Locale.Category.FORMAT));
        setZoneShared(true);
    }
    ...
    public GregorianCalendar(Locale aLocale) {
        this(java.util.TimeZone.getDefaultRef(), aLocale);
        setZoneShared(true);
    }
     ...
     * @param aLocale the given locale.
     */
    public GregorianCalendar(java.util.TimeZone zone, Locale aLocale) {
        super(zone, aLocale);
...
/////////////////
    ...
    private void setGregorianChange(long cutoverTime) {
        ...
        d = (BaseCalendar.Date) jcal.newCalendarDate(java.util.TimeZone.NO_TIMEZONE);
    ...
    public final java.util.Date getGregorianChange() {
        return new java.util.Date(gregorianCutover);
    }
        ...
        case DAY_OF_WEEK_IN_MONTH:
            {
                ...
                BaseCalendar.Date d = (BaseCalendar.Date) cal.newCalendarDate(java.util.TimeZone.NO_TIMEZONE);
     ...
     * java.util.Calendar#get(int) get} method for any possible time value,
     ...
     * java.util.Calendar#WEEK_OF_YEAR WEEK_OF_YEAR} based on the {@link
     * java.util.Calendar#YEAR YEAR} (calendar year) value, not the <a
        ...
        case WEEK_OF_YEAR:
            {
                if (!gc.isCutoverYear(normalizedYear)) {
                    ...
                    CalendarDate d = cal.newCalendarDate(java.util.TimeZone.NO_TIMEZONE);
    ...
    public java.util.TimeZone getTimeZone() {
        java.util.TimeZone zone = super.getTimeZone();
     ...
     * (calendar year) value.
     *
     * <p>This method calls {@link java.util.Calendar#complete()} before
     ...
     * {@link java.util.Calendar#DAY_OF_WEEK DAY_OF_WEEK} values: {@link
     * java.util.Calendar#SUNDAY SUNDAY} to {@link java.util.Calendar#SATURDAY SATURDAY}.
     *
...
/////////////////////////////
    ...
    protected void computeTime() {
        ...
        java.util.TimeZone zone = getZone();
        if (zoneOffsets == null) {
            zoneOffsets = new int[2];
        }
     ...
     * @see java.util.Calendar#selectFields
     */
    ...
    private final int actualMonthLength() {
        ...
        if (cdate != gdate) {
            date = (BaseCalendar.Date) gcal.newCalendarDate(java.util.TimeZone.NO_TIMEZONE);
        }
