 ...
 * </code>character sequence<code>} by interpreting a {@link java.util.regex.Pattern}.
 *
 * <p> A matcher is created from a pattern by invoking the pattern's {@link
 * java.util.regex.Pattern#matcher matcher} method.  Once created, a matcher can be used to
...
public final class Matcher implements MatchResult {
     ...
     */
    Matcher(java.util.regex.Pattern parent, CharSequence text) {
    ...
    /**
      ...
      * @since 1.5
      */
    public Matcher usePattern(java.util.regex.Pattern newPattern) {
        if (newPattern == null)
        ...
        while (cursor < replacement.length()) {
            ...
            if (nextChar == '\\') {
                ...
                if (nextChar == '{') {
                    ...
                    while (cursor < replacement.length()) {
                        nextChar = replacement.charAt(cursor);
                        if (java.util.regex.ASCII.isLower(nextChar) ||
                            java.util.regex.ASCII.isUpper(nextChar) ||
                            java.util.regex.ASCII.isDigit(nextChar)) {
                            gsb.append(nextChar);
                            cursor++;
                        } else {
                            break;
                    ...
                    if (java.util.regex.ASCII.isDigit(gname.charAt(0)))
                        throw new IllegalArgumentException(
